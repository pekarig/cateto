<!-- ============================
   AI és a jövő Hero Section (time-tracking style)
   ============================= -->
<section class="md:mt-4 lg:mt-6 xl:mt-[30px]">
   <div
      ...
      <video
         ...
         muted
         loop
         poster="{{ asset('images/fallback/ai-jovo-hero.jpg') }}"
         >
         <source src="{{ asset('video/Tube-dark.mp4') }}" type="video/mp4" />
         ...
         <div class="space-y-3 md:space-y-5 text-center md:text-left max-lg:max-w-[500px]">
            ...
            <div class="space-y-2.5 md:space-y-4">
               <h1 data-ns-animate data-delay="0.2" class="max-w-[666px] leading-[1.2]">
                  ...
                  Ez még a jövő vagy már a jelen?
                  </span>
               </h1>
               <p data-ns-animate data-delay="0.3" class="text-accent/60 max-w-[580px]">
                  Mesterséges intelligencia alapú eszközök és automatizálási megoldások a hatékonyabb munkavégzésért.
               </p>
            </div>
         </div>
      </div>
